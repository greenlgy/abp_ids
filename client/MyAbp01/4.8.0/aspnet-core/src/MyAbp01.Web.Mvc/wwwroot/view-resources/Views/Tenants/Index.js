...
/*            abp.ajax({
            ...
            $.post(
                abp.appPath + 'Tenants/EditTenantModal?tenantId=' + tenantId,
                function (data, status) {
                    $('#TenantEditModal div.modal-content').html(data);
                }
            );
        });
        ...
        function deleteTenant(tenantId, tenancyName) {
            abp.message.confirm(
                abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'MyAbp01'), tenancyName),
