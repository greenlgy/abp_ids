...
/*			abp.ajax({
			...
			$.post(
				abp.appPath + 'Roles/EditRoleModal?roleId=' + roleId,
				function (data, status) {
					$('#RoleEditModal div.modal-content').html(data);
				}
			);
		});
		...
		function deleteRole(roleId, roleName) {
			abp.message.confirm(
                abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'MyAbp01'), roleName),
